...
{ 
    ...
    { 
        $userObj | Add-Member -Type NoteProperty -Name UserMessage -Value "Heute" 
    } 
    ...
    { 
        ...
        $userObj | Add-Member -Type NoteProperty -Name UserMessage -Value "in $days Tagen" 
    } 
...
{ 
    ...
    # Subject Setting 
    $subject="Dein Passwort wird $messageDays ablaufen!" 
    # Email Body Set Here, Note You can use HTML, including Images. 
    $body =" 
    <font face=""verdana""> 
    Hallo $name, 
    <p> Dein Passwort wird $messageDays ablaufen.<br> 
    Du kannst Dein Passwort ändern, indem Du CTRL ALT Delete drückst und dann Change a Password wählst.<br> 
    <br> 
    Bitte beachte: Du solltest per VPN oder direkt intern mit dem blauen Netzwerk verbunden sein. </p>
    <p> Vergiss nicht, das geänderte Passwort auch in SecurePIM nachzutragen, damit Mails wieder synchronisiert werden. </P>
    <p>Dankeschön, <br><br>
     
    IT Support 
    <a href=""mailto:it@oneconsult.com""?Subject=Password Expiry Assistance"">it@oneconsult.com</a></p>
    </font>" 
